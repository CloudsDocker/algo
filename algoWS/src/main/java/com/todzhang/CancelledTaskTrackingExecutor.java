 ...
 * ExecutorService that keeps track of cancelled tasks after shut-
 down.
 */
public class CancelledTaskTrackingExecutor extends AbstractExecutorService{
    ...
    public List<Runnable> getCancelledTasks(){
        ...
        return new ArrayList<>(tasksCancelledShutdown);
    }
    public CancelledTaskTrackingExecutor(ExecutorService exec) {
        this.exec = exec;
    }
